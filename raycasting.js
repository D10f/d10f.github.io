var Module = (() => {
    ...
    return async function (moduleArg = {}) {
        ...
        (() => {
            ...
            function loadPackage(metadata) {
                ...
                function fetchRemotePackage(
                    ...
                    fetch(packageName)
                        .catch((cause) =>
                            Promise.reject(
                                new Error(`Network Error: ${packageName}`, {
                                    cause,
                                }),
                            ),
                        )
                ...
                function runWithFS(Module) {
                    ...
                    function processPackageData(arrayBuffer) {
                        ...
                        Module["removeRunDependency"](
                            // "datafile_public/raycasting.data",
                            "http://localhost:3000/raycasting.data",
                        );
                    }
            ...
            loadPackage({
                files: [
                    { filename: "/images/bluestone.png", start: 0, end: 2793 },
                    {
                        filename: "/images/colorstone.png",
                        start: 2793,
                        end: 6070,
                    },
                    { filename: "/images/eagle.png", start: 6070, end: 9846 },
                    {
                        filename: "/images/graystone.png",
                        start: 9846,
                        end: 13672,
                    },
                    {
                        filename: "/images/mossystone.png",
                        start: 13672,
                        end: 18179,
                    },
                    {
                        filename: "/images/pikuma.png",
                        start: 18179,
                        end: 21627,
                    },
                    {
                        filename: "/images/purplestone.png",
                        start: 21627,
                        end: 26140,
                    },
                    {
                        filename: "/images/redbrick.png",
                        start: 26140,
                        end: 29355,
                    },
                    { filename: "/images/wood.png", start: 29355, end: 30800 },
                ],
                remote_package_size: 30800,
            });
        })();
        var arguments_ = [];
        ...
        function findWasmBinary() {
            if (Module["locateFile"]) {
                return locateFile("raycasting.wasm");
            }
            return new URL("raycasting.wasm", import.meta.url).href;
        }
        ...
        var ASM_CONSTS = {
            ...
            75711: ($0, $1, $2, $3) => {
                ...
                if (SDL2.audioContext.state === "suspended") {
                    ...
                    var silence_callback = function () {
                        ...
                        SDL2.audio.currentOutputBuffer =
                            SDL2.audio.silenceBuffer;
                        dynCall("vi", $2, [$3]);
            ...
            81594: () => window.innerWidth,
            81624: () => window.innerHeight,
        };
        var wasmImports = {
            ...
            Wa: _emscripten_glClipControlEXT,
            ...
            Va: _emscripten_glPolygonModeWEBGL,
            _b: _emscripten_glPolygonOffset,
            Xa: _emscripten_glPolygonOffsetClampEXT,
            ...
            j: _emscripten_sample_gamepad_data,
            k: _emscripten_set_beforeunload_callback_on_thread,
            w: _emscripten_set_blur_callback_on_thread,
            ...
            q: _emscripten_set_keydown_callback_on_thread,
            o: _emscripten_set_keypress_callback_on_thread,
            p: _emscripten_set_keyup_callback_on_thread,
            ...
            m: _emscripten_set_resize_callback_on_thread,
            s: _emscripten_set_touchcancel_callback_on_thread,
            ...
            l: _emscripten_set_visibilitychange_callback_on_thread,
        ...
        var ___wasm_call_ctors = wasmExports["wd"];
        var _malloc = wasmExports["xd"];
        var _reset_frame_time = (Module["_reset_frame_time"] =
            wasmExports["yd"]);
        var _main = (Module["_main"] = wasmExports["zd"]);
        var __emscripten_stack_restore = wasmExports["Bd"];
        var __emscripten_stack_alloc = wasmExports["Cd"];
        var _emscripten_stack_get_current = wasmExports["Dd"];
        function callMain() {
